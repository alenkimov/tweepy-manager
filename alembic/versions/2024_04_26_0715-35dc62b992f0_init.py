...
Revision ID: 35dc62b992f0
Revises: 
Create Date: 2024-04-26 07:15:17.273494
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("followed_to_user_id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("retweeted_tweet_id", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ["quote_tweet_id"],
            ["tweet.id"],
        ),
